# 🧩 6x6 Sudoku Solver with Transformer
...
├── src/
│   ├── data/
│   │   ├── generator.py         # 스도쿠 생성, 검증(Solver), 전처리 로직
│   │   └── dataset.py           # PyTorch Dataset 클래스
│   ├── model/
│   │   └── transformer.py       # 구조적 임베딩이 적용된 Transformer 모델
│   └── utils.py
...
| 항목 | 설정값 | 설명 |
| :--- | :--- | :--- |
| **Grid Size** | 6x6 | Flattened sequence length: 36 |
